...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark border-bottom border-bottom-dark ticky-top bg-body-tertiary"
        data-bs-theme="dark">
        <div class="container">
            <a class="navbar-brand fw-light" href="/"><span class="fas fa-brain me-1"> </span>Cerita</a>
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    <p class="text-muted">&copy; {{ config('sistemkv.umum.tahun_terbitan') }}. {{ config('sistemkv.umum.site_copyright') }}</p>
                </div>
                <!-- Tamat div text-center -->
            </div>
            <!-- Tamat div col-12 -->
        </div>
        <!-- Tamat div row -->
